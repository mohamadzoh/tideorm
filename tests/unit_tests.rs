...
mod seeding_tests {
    use tideorm::seeding::{SeedResult, SeedInfo, SeedStatus};
    ...
    fn test_seed_result_has_executed() {
        let result = SeedResult {
            executed: vec![SeedInfo { name: "test_seed".to_string() }],
            skipped: Vec::new(),
            rolled_back: Vec::new(),
        };
    ...
    fn test_seed_result_has_rolled_back() {
        let result = SeedResult {
            executed: Vec::new(),
            skipped: Vec::new(),
            rolled_back: vec![SeedInfo { name: "test_seed".to_string() }],
        };
        assert!(!result.has_executed());
        assert!(result.has_rolled_back());
    }
    ...
    fn test_seed_result_total() {
        let result = SeedResult {
            executed: vec![SeedInfo { name: "seed1".to_string() }],
            skipped: vec![SeedInfo { name: "seed2".to_string() }],
            rolled_back: vec![SeedInfo { name: "seed3".to_string() }],
        };
    ...
    fn test_seed_result_display() {
        let result = SeedResult {
            executed: vec![SeedInfo { name: "user_seeder".to_string() }],
            skipped: vec![SeedInfo { name: "category_seeder".to_string() }],
            rolled_back: Vec::new(),
        };
    ...
    fn test_seed_result_display_rolled_back() {
        let result = SeedResult {
            executed: Vec::new(),
            skipped: Vec::new(),
            rolled_back: vec![SeedInfo { name: "test_seeder".to_string() }],
        };
        let display = format!("{}", result);
    ...
    fn test_seed_info_clone() {
        let info = SeedInfo { name: "test_seed".to_string() };
        let cloned = info.clone();
        assert_eq!(info.name, cloned.name);
    }
    ...
    fn test_seed_result_clone() {
        let result = SeedResult {
            executed: vec![SeedInfo { name: "s1".to_string() }],
            skipped: vec![SeedInfo { name: "s2".to_string() }],
            rolled_back: vec![SeedInfo { name: "s3".to_string() }],
        };
    ...
    fn test_seed_result_multiple_seeds() {
        let result = SeedResult {
            executed: vec![
                SeedInfo { name: "seed1".to_string() },
                SeedInfo { name: "seed2".to_string() },
                SeedInfo { name: "seed3".to_string() },
            ],
            skipped: Vec::new(),
            rolled_back: Vec::new(),
        };
